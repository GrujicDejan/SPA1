...
class ListaZnakova {
  ...
  public  void ispisiOdPoslDoPrvog() { 
    Element tek = prvi, sled, stari = null;
    while (tek != null) {
      sled = tek.veza;
      tek.veza = stari;
      stari = tek;
...
// zamenjuje prvi i drugi ?vor JPL.
    if (prvi != null && prvi.veza != null) {
      Element pom = prvi.veza;
      prvi.veza.veza = prvi;
      prvi.veza = pom;
